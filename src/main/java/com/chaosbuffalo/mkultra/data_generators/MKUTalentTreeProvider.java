...
public class MKUTalentTreeProvider extends DataGenerators.TalentTreeDataGenerator {
    ...
    private void generateCoreTree(@Nonnull DirectoryCache cache){
        ...
        line.addNode(new UUIDTalentNode(CoreTalents.ABILITY_SLOT_TALENT, UUID.fromString("119917ea-b852-4cb5-8bfe-2cdad488f279")));
        line.addNode(new UUIDTalentNode(CoreTalents.POOL_COUNT_TALENT, UUID.fromString("108549d0-7935-4386-bf38-2ca48329305e")));
        ...
        line.addNode(new UUIDTalentNode(CoreTalents.ABILITY_SLOT_TALENT, UUID.fromString("121817fa-1cfc-4334-aa77-13c02ede83ff")));
        ...
        line.addNode(new UUIDTalentNode(CoreTalents.PASSIVE_ABILITY_SLOT_TALENT, UUID.fromString("95725b31-da3a-4a3e-b6cc-e5036a6e9a87")));
        line.addNode(new TalentNode(MKUTalents.LIFE_SIPHON_TALENT));
        tree.addLine(line);
        TalentLineDefinition magic = new TalentLineDefinition(tree, "magic");
        magic.addNode(new UUIDTalentNode(CoreTalents.ABILITY_SLOT_TALENT, UUID.fromString("2e1ff629-b139-4303-831d-1c1bc5ebc21e")));
        magic.addNode(new UUIDTalentNode(CoreTalents.POOL_COUNT_TALENT, UUID.fromString("9b23bee2-d159-4d32-aca8-1d726de0f875")));
        ...
        magic.addNode(new AttributeTalentNode(CoreTalents.MANA_REGEN_TALENT, 2, 0.25));
        magic.addNode(new UUIDTalentNode(CoreTalents.ULTIMATE_ABILITY_SLOT_TALENT, UUID.fromString("0c751a99-a186-439c-83f1-abb55f67b17e")));
        magic.addNode(new AttributeTalentNode(CoreTalents.MANA_REGEN_TALENT, 2, 0.25));
        magic.addNode(new AttributeTalentNode(CoreTalents.MANA_REGEN_TALENT, 2, 0.25));
        magic.addNode(new UUIDTalentNode(CoreTalents.PASSIVE_ABILITY_SLOT_TALENT, UUID.fromString("4818f37e-16c4-4010-ab7a-a664cab4ab97")));
        ...
        magic.addNode(new UUIDTalentNode(CoreTalents.POOL_COUNT_TALENT, UUID.fromString("93de6f66-4d6d-4721-b774-b12ee92be288")));
        magic.addNode(new UUIDTalentNode(CoreTalents.ULTIMATE_ABILITY_SLOT_TALENT, UUID.fromString("ecfaa441-35c7-46ce-aa67-f8372bc4fd7d")));
        tree.addLine(magic);
        TalentLineDefinition heal = new TalentLineDefinition(tree, "healing");
        heal.addNode(new UUIDTalentNode(CoreTalents.ABILITY_SLOT_TALENT, UUID.fromString("3a31b74d-cf08-451f-a483-8eb9e47ce89b")));
        heal.addNode(new UUIDTalentNode(CoreTalents.POOL_COUNT_TALENT, UUID.fromString("fbbab80a-c3f8-460f-81cf-5184a7c7f39a")));
        ...
        heal.addNode(new UUIDTalentNode(CoreTalents.ABILITY_SLOT_TALENT, UUID.fromString("de5a37a4-b7e5-4565-9217-2d5d8de5d448")));
        ...
        heal.addNode(new UUIDTalentNode(CoreTalents.PASSIVE_ABILITY_SLOT_TALENT, UUID.fromString("05865420-0069-45e1-856e-331c9900f99c")));
