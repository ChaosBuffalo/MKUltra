...
public class MKUQuestProvider extends QuestDefinitionProvider {
    ...
    private QuestDefinition generateIntroQuest(){
        ...
        TalkToNpcObjective retSmithTalk = new TalkToNpcObjective("return_to_smith", MKUWorldGen.INTRO_CASTLE_NAME, 0,
                new ResourceLocation("mkultra", "green_smith"), new StringTextComponent("Talk to the Green Smith with a weapon in your hand."));
        ...
        Quest greenLadyTrainTalent = new Quest("green_lady_talent", new StringTextComponent("Talk to the Green Lady to learn more about developing your magical abilities"));
        greenLadyTrainTalent.setAutoComplete(true);
        TalkToNpcObjective greenLadyTalent = new TalkToNpcObjective("green_lady_talent", MKUWorldGen.INTRO_CASTLE_NAME, 0,
                new ResourceLocation("mkultra", "green_lady"), new StringTextComponent("Talk to the Green Lady about the talent system."));
        ...
        Quest returnToGreenLady = new Quest("return_to_green_lady", new StringTextComponent("The Green Lady wants you to learn about spending talent points."));
        returnToGreenLady.setAutoComplete(true);
        TalkToNpcObjective retGreenLady = new TalkToNpcObjective("return_to_green_lady", MKUWorldGen.INTRO_CASTLE_NAME, 0,
                new ResourceLocation("mkultra", "green_lady"), new StringTextComponent("Talk to the Green Lady after training a talent."));
        DialogueNode hailWithTraining = new DialogueNode("hail_w_training", "Great, but you're going to need more than just a sharp rock where we're going. " +
                "Go back and talk to the Green Lady, ask her about learning to develop your magical talents.");
        ...
        DialogueNode hailWithoutTraining = new DialogueNode("hail_wo_training", "Come back to me when you have spent your first talent point.");
