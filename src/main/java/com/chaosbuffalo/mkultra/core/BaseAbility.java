...
public abstract class BaseAbility extends IForgeRegistryEntry.Impl<BaseAbility> {
    ...
    protected List<EntityLivingBase> getTargetsInLine(EntityLivingBase caster, Vec3d from, Vec3d to, boolean checkValid) {
        return RayTraceUtils.getEntitiesInLine(EntityLivingBase.class, caster, from, to, Vec3d.ZERO, .75f,
