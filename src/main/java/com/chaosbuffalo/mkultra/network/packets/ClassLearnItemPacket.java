...
public class ClassLearnItemPacket implements IMessage {
    private ResourceLocation classId;
    private boolean learn;
    private boolean enforceChecks;

    public ClassLearnItemPacket() {
    }

    public ClassLearnItemPacket(ResourceLocation classId, boolean learn, boolean enforceChecks) {
    ...
    public static class Handler extends MessageHandler.Server<ClassLearnItemPacket> {

        @Override
        public void handleServerMessage(final EntityPlayer player,
                                        final ClassLearnItemPacket msg) {
            ...
            if (data != null) {
                ...
                if (msg.learn) {
                    canSwitch = data.learnClassItem(msg.classId, msg.enforceChecks);
