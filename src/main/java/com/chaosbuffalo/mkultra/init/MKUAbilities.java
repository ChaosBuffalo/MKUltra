...
public class MKUAbilities {
    ...
    public static final DeferredRegister<MKAbility> REGISTRY = DeferredRegister.create(MKAbility.class, MKUltra.MODID);
    //misc
    public static final RegistryObject<WrathBeamAbility> WRATH_BEAM = REGISTRY.register("ability.wrath_beam", WrathBeamAbility::new);
    public static RegistryObject<WrathBeamFlurryAbility> WRATH_BEAM_FLURRY = REGISTRY.register("ability.wrath_beam_flurry", WrathBeamFlurryAbility::new);
