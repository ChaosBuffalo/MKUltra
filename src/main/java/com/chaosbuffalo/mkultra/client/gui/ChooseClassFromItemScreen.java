...
public class ChooseClassFromItemScreen extends GuiScreen {
    ...
    public ChooseClassFromItemScreen(boolean showAll, boolean enforceChecks) {
        currentPage = 0;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (learning) {
            if (enforceChecks) {
                ...
                classes = MKURegistry.getClassesForProvider((IClassProvider) main.getItem());
            }
            else {
